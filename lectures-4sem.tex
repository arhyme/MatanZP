...
\begin{lemma}
	Если многообразие задано параметрически, то оно ориентированно.
\end{lemma}
...
\begin{lemma}
	Многообразие заданное системой уравнений всегда ориентируемо.
\end{lemma}
...
\subsection{Лекция 29.03.19} %Лекция 29.03.19
